            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-1.5 flex-wrap">
                  <span className="px-2 py-0.5 rounded-md text-[11.5px] font-semibold bg-neutral-100 text-slate-700 border border-neutral-200/80">
                    {post.seller.classGroup}
                  </span>
                  <span className="px-2 py-0.5 rounded-md text-[11.5px] font-semibold bg-amber-50 text-amber-700 border border-amber-200/80">
                    {stockBadgeText}
                  </span>
                </div>
              </div>
