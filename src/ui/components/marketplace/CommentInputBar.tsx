...
export const CommentInputBar: React.FC<CommentInputBarProps> = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 max-w-xl mx-auto bg-white/95 backdrop-blur-md border-t border-neutral-200 px-4 py-2.5 z-40 font-gt-standard shadow-lg">
      <form onSubmit={handleSubmit} className="flex items-center gap-2.5">
        ...
        <input
          ...
          placeholder={replyToUser ? `Balas @${replyToUser}...` : 'Ketik balasan / pertanyaan produk...'}
