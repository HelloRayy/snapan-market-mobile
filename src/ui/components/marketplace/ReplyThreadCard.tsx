  ...
  const renderParentImages = () => {
    ...
    return (
      <div
        ...
        className="flex gap-2.5 overflow-x-auto no-scrollbar scrollbar-none mt-2.5 cursor-grab active:cursor-grabbing select-none touch-pan-x -ml-[48px] sm:-ml-[52px] -mr-4 pl-4 pr-4"
      >
