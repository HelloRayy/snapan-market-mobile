  ...
  const renderParentImages = () => {
    ...
    return (
      <div
        ...
        className="flex gap-2.5 overflow-x-auto no-scrollbar scrollbar-none mt-2.5 cursor-grab active:cursor-grabbing select-none overscroll-x-contain touch-auto ml-0 -mr-4 pl-0 pr-4 w-[calc(100%+16px)] max-w-[calc(100%+16px)]"
