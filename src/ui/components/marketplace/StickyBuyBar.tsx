  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 max-w-xl mx-auto z-40 font-gt-standard">
      ...
      <div className="bg-white border-t border-neutral-200/80 px-4 pt-3 pb-7 pb-[calc(1.75rem+env(safe-area-inset-bottom,0px))] rounded-t-[24px] shadow-[0_-4px_25px_rgba(0,0,0,0.08)] space-y-3.5">
        ...
        {/* Right Kumo Primary Button: Left Label --- Right Price (Reduced Font Weight) */}
        <button
          type="button"
          onClick={onBuyClick}
          className="relative inline-flex items-center justify-between flex-1 h-11 px-4.5 rounded-xl text-white font-medium text-[13.5px] bg-[#1d64ec] border border-[#154ec1] shadow-md shadow-blue-500/20 active:scale-[0.98] transition-all cursor-pointer overflow-hidden select-none group"
        >
